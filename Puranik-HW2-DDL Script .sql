...
(
    ...
    Member_ID          NUMBER        REFERENCES Members(Member_ID)        NOT NULL,
    ...
    CONSTRAINT Maturity_Orgination_check CHECK (Maturity_Date>=Origination_Date)
);
...
INSERT INTO members
VALUES (DEFAULT,'Vineet','Satish','Puranik','vsp476@utexas.edu');
INSERT INTO members
VALUES (DEFAULT,'Rishi','Naidu','Karanam','rishikaranam@utexas.edu');
Commit;
...
VALUES (90001, 1, 'John', 'Mayer', 123456789, '01/15/1980', '123 Main St', 'Springfield', 'IL', '62701', '555-123-4567', 'john.doe@email.com', '3');
INSERT INTO Employees
VALUES (90002, 2, 'Jane', 'Goodall', 987654321, '02/20/1985', '456 Elm St', 'Lexington', 'KY', '40502', '555-987-6543', 'jane.smith@email.com', '2');
INSERT INTO Employees
VALUES (90003, 1, 'Robert', 'King', 555555555, '03/10/1975', '789 Oak St', 'Springfield', 'IL', '62701', '555-555-5555', 'robert.johnson@email.com', '4');
INSERT INTO Employees
VALUES (90004, 2, 'Lisa', 'Monroe', 111111111, '04/05/1990', '101 Pine St', 'Lexington', 'KY', '40502', '555-111-1111', 'lisa.wilson@email.com', '5');
Commit;
INSERT INTO Loans
VALUES('123abc123abc',1,'AB',10,'28-SEP-2023',3,20.111,50,'29-SEP-2023',100,90001,'P');
INSERT INTO Loans
VALUES('223abc123abc',1,'CA',11,'22-SEP-2023',4,20.112,60,'23-SEP-2023',101,90002,'C');
INSERT INTO Loans
VALUES('323abc123abc',2,'MM',12,'24-SEP-2023',5,20.113,70,'25-SEP-2023',102,90003,'D');
INSERT INTO Loans
VALUES('423abc123abc',2,'LL',13,'25-SEP-2023',6,20.114,80,'26-SEP-2023',103,90004,'R');
Commit;

INSERT INTO Transaction_History
VALUES(DEFAULT,'123abc123abc', '28-JUN-2023',500,'Paid 500 Dollars',1000);
INSERT INTO Transaction_History
VALUES(DEFAULT,'123abc123abc', '28-JUL-2023',600,'Paid 600 Dollars',500);
Commit;
